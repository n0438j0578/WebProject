...
$sql_query_product = "SELECT * FROM product WHERE (name LIKE '%".$_GET["keyword"]."%' OR des LIKE '%".$_GET["keyword"]."%' )";
...
if($query_product){ ?>
<html>
<title>Search result - <?php echo $store_name_banner ?></title>
<meta charset="UTF-8">
...
<body class="w3-content" style="max-width:1200px">
    ...
    <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
        <div class="w3-container w3-display-container w3-padding-16">
            ...
            <h3 class="w3-wide"><b><?php echo $store_name_banner ?></b></h3>
        </div>
    ...
    <div class="w3-main" style="margin-left:250px">
        ...
        <div class="w3-row-padding">
                ...
                <div class="w3-third w3-container">
                    ...
                    <p>
                        <a href="product_detail.php/?idq=<?php echo $id; ?>" style="text-decoration: none">
                            <?php echo $array_product[ 'name']; ?>
                        </a>
                        <br><b><?php echo $array_product['price']; ?> Baht.</b>
                    </p>
                </div>
                <?php $round_count++; } ?>
            </div>
            ...
            <div class="w3-black w3-center w3-padding-24"> ยินดีต้อนรับสู่ร้าน <?php echo $store_name_banner ?> </a>
            </div>
                ...
                <div class="w3-container w3-white w3-center">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $values[ "item_price"]; ?> Baht.</td>
                            <td>X
