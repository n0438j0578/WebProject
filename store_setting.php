...
<body class="w3-content" style="max-width:1200px; margin-top: 25px;">
    ...
    <div class="w3-main" style="margin-left:250px">
        ...
        <div class="borderDiv">
            <form method="POST" action="store_setting.php" enctype="multipart/form-data">
                
                <div class="row" style="margin-top: 20px">
                    <div class="col-lg-1"></div> 
                    <div class="col-lg-3">
                        <img src="icon\store.png" alt="Storepic" height="150" width="150" style="margin-left: 50px; margin-top: 20px">
                    </div>
                    ...
                    <div class="col-lg-6" style="margin-top: 10px">
                        ...
                        <br>
                        <input class="w3-input w3-border" type="file" name="storeImage" placeholder="Enter Image path">
                        <br>
                    </div>
                </div>
                    
                <div align="center" style="margin-bottom: 20px; margin-top: 10px">
                    <input type="submit" name="saveBtn" class="w3-button w3-border w3-round-large w3-green w3-hover-white" style="margin-right: 20px" value="Save">
