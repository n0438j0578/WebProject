...
<html>
<title><?php echo $store_name_banner ?></title>
<meta charset="UTF-8">
...
<body class="w3-content" style="max-width:1200px">
    ...
    <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
        <div class="w3-container w3-display-container w3-padding-16">
            ...
            <h3 class="w3-wide"><a href="index.php" style="text-decoration: none"><b><?php echo $store_name_banner ?></b></a></h3>
        </div>
            ...
            <div class="w3-modal-content w3-animate-zoom" style="padding:32px">
                <div class="w3-container w3-white w3-center">
                    ...
                    <form method="POST" action="addItem.php" enctype="multipart/form-data">
                        ...
                        <p>
                            <textarea class="w3-input w3-border" type="text" placeholder="Enter Desciption (If any)" name="itemDes"></textarea>
                        </p>
                        <p>
